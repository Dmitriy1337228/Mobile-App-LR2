...
class SelectiveTestActivity : AppCompatActivity() {
    private var correctAnswers = 0
    private var questionCount = 0
    private val totalQuestions = 20
    private var selectedNumber = 2 // Число, введенное пользователем
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Получаем число, введенное пользователем из MainActivity
        ...
        fun generateNewQuestion() {
            ...
            questionTextView.text = "Сколько будет $selectedNumber * $num2?"
        ...
        checkButton.setOnClickListener {
            ...
            if (userAnswer != null) {
                questionCount++
                if (userAnswer == selectedNumber * num2) {
                    correctAnswers++
